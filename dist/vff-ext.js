...
var _typeit = __webpack_require__(2);
...
var VFFTypewriter = function (_HTMLElement) {
    _inherits(VFFTypewriter, _HTMLElement);

    function VFFTypewriter() {
        _classCallCheck(this, VFFTypewriter);

        var _this = _possibleConstructorReturn(this, (VFFTypewriter.__proto__ || Object.getPrototypeOf(VFFTypewriter)).call(this));

        _this.typed;
        _this._shadowRoot = _this.attachShadow({ mode: 'open' });
        _this._shadowRoot.appendChild(template.content.cloneNode(true));
        window.vff.ready(function () {
            _this.vffReady = true;
        });
        return _this;
    }

    _createClass(VFFTypewriter, [{
        ...
        value: function typeText(text) {
            ...
            setTimeout(function () {
                var options = Object.assign({}, defaultTypeOptions, {
                    cursor: _this2.cursor,
                    speed: _this2.speed
                });
                options.strings = text.split('\n');
                _this2.typed = new _typeit2.default(_this2.p, options).go();
            }, 1);
        }
    }, {
        key: 'render',
    ...
    return VFFTypewriter;
}(HTMLElement);

exports.default = VFFTypewriter;
